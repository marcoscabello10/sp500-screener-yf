    ...
    return {
        ...
        'industrias': {'disponible': True, 'cobertura_pct': 100, 'sin_dato': [],
                       'concentradas': [{'industria': 'Banks - Diversified',
                                         ...
                                         'denominador': 'valor de la cartera',
                                         'tickers': ['TCK1', 'TCK2']}]},
        # La compuerta de datos. Entro el 03/09.
        'datos': {'nivel': 'parcial', 'puede_decidir': True,
                  'con_reservas': True,
                  'no_se_puede_afirmar': [
                      'que la volatilidad de la cartera sea X%: ese numero '
                      'cubre el 87.5%',
                      'que la calidad promedio de la cartera sea alta o baja: '
                      '38% de la cartera no tiene puntaje']},
